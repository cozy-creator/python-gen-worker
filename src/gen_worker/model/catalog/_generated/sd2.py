"""Typed bindings for the 'sd2' family — generated by `gen-worker model generate`.

DO NOT EDIT. Regenerate with:

    gen-worker model generate <path>/sd2.export.json --spec gen_worker.model.catalog.sd15:SD2
...
def _declaration() -> ModelSpec | None:
    ...
    try:
        from gen_worker.model.catalog.sd15 import SD2
    except ImportError:
        return None
    return SD2
...
Sd2Layout = Literal['bf16']


class Sd2(Model):
    """The 'sd2' family: the TYPE of a handler parameter.
    ...
    resolve one per request with ``Sd2.instance(ref)``, or run a test
    hubless with ``Sd2.fake()``.
    """
    ...
    def clip(
        ...
        *,
        ...
        """Call the 'clip' graph class of 'sd2'.
    ...
    def decoder(
        ...
        *,
        ...
        """Call the 'decoder' graph class of 'sd2'.
    ...
    def denoiser(
        ...
        *,
        ...
        """Call the 'denoiser' graph class of 'sd2'.

"""Typed bindings for the EAGER 'musicgen' model — generated by `gen-worker model generate`.

DO NOT EDIT. Regenerate with:

    gen-worker model generate <path>/musicgen.eager.json --spec gen_worker.model.catalog.boundary_audio:MUSICGEN
...
from gen_worker.model.catalog.boundary_audio import MUSICGEN
...
_EXPORT_FILE = "musicgen.eager.json"
_EAGER = EagerExport.loads(
    resources.files(__package__).joinpath(_EXPORT_FILE).read_bytes()
)

_SPEC: ModelSpec | None = MUSICGEN


class Musicgen(Model):
    """The eager 'musicgen' model: the TYPE of a handler parameter.
    ...
    resolve one per request with ``Musicgen.instance(ref)``, or run a test
    hubless with ``Musicgen.fake()``.
    """

    __slots__ = ()

    FAMILY: ClassVar[str] = 'musicgen'
    EXPORT_DIGEST: ClassVar[str] = '9d2adbfccaee1d1a1be866667bcb813a'

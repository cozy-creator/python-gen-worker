...
tensorfs owns CAS manifests, objects, transfer sessions, and transfer recovery.
...
``convert/`` because executor, fleet_compiled_graphs, and request_context also use them.

...
— could not be run at all before the first ``gen-worker family generate``,
...
Adding a family is: write the declaration module, ``gen-worker family export``
it, ``gen-worker family generate`` its bindings, add two lines below. That is a

...
def _fetch_receipt_jws(cfg: _Config, digests: Mapping[str, str], cell_key: str) -> str:
    ...
    pgw#763 delta 1: routed through the broker so the parent attaches the
    worker JWT (the compute child holds none); single-process sends the
    identical GET directly.
    """

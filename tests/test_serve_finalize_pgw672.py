...
a worker MINTS its compiled graph (publish-intent 200, armed, obligation discharged),
...
# finalizes`, `test_same_key_rearm_reuses_finalized_compiled_graph_with_a_real_fx_hit`)
...
def test_a_mandatory_lane_without_a_declaration_fails_closed_before_it_compiles(
    ...
    with pytest.raises(cc.CompiledExecutionLaneImpossibleError, match="compiled_graph"):
        fleet_compiled_graphs.enable_compiled(

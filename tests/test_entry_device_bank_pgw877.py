...
# §4.28 / pgw#1092: the pool takes no goal set any more. The forge is deleted,
# so every mint runs beside a tenant and all three reserves are unconditional.
...
def test_the_measured_entry_ask_reaches_the_width_and_says_it_is_measured(
    ...
    common: Dict[str, Any] = dict(
        ...
        free_vram_bytes=int(21.48 * _GIB), device_lock=True)

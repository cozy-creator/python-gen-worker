...
def make_claims(
    ...
    **overrides: Any,
    ...
    artifact: Dict[str, Any] = {"path": "graph.tar.gz", "size_bytes": size_bytes}
...
def worker_jwt_for(endpoint_id: str, org_id: str = "") -> str:
    ...
    th#1657: the pod's own identity comes from the `graph_read_endpoint_id` the
    ...
    claims = {"sub": "worker-1", "graph_read_endpoint_id": endpoint_id}
    ...
    if org_id:
        claims["graph_read_org_id"] = org_id

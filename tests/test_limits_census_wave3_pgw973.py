...
Two shapes are proven here, both on the real code paths:

1. **Nothing that can end real work keys on a wall clock**. The lane
...
2. **A duplicated bound has one owner.** Four verbatim pairs collapse; the
...
# ---------------------------------------------------------------------------
# 1. transport.SendQueue — `maxsize <= 0` deleted the bound outright
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2. lane_residency_gate — a flat deadline over a live progress signal
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 3. Deletions — the bounds that were never read
# ---------------------------------------------------------------------------

...
def _interpreter_mounts() -> list[Path]:
    ...
    parents are collapsed. pgw#963: mounting only the last of the three —
...
def test_privilege_isolation_rows_under_a_real_root_parent():
    ...
    # pgw#963, the third-party half: `ubuntu:24.04` comes from Docker Hub, which
    ...
    # passing on every developer box. It is also, until pgw#963, how this row
